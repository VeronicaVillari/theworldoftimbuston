document.addEventListener("DOMContentLoaded", function() {
    const esordiLink = document.getElementById('esordi');
    ...
    esordiLink.addEventListener('click', function(event) {
        ...
        setActiveLink(esordiLink);
        filterImages('esordi');
    });

    protagonistiLink.addEventListener('click', function(event) {
        event.preventDefault();
        setActiveLink(protagonistiLink);
        filterImages('protagonisti');
    });

    temiLink.addEventListener('click', function(event) {
        event.preventDefault();
        setActiveLink(temiLink);
        filterImages('temi');
    });
...
// risorsa da www.bytewebster.com
